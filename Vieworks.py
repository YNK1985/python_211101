...
for n in range(0,10):
        #클리앙의 중고장터 주소 
        data ='https://xrayimaging.vieworks.com/en/detector/industrial?#content_category'
        print(data)
        #웹브라우져 헤더 추가 
...
# </span>        
        ...
        list = soup.find_all('div', attrs={'class':'txtBox floatClear'}) #태그
